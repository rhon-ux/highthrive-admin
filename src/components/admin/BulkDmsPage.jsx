...
export default function BulkDmsPage({ onNotify }) {
  ...
  const matched = useMemo(
    () => filterBulkDmMembers(MOCK_BULK_DM_MEMBERS, { ...filters, search: memberSearch }),
    ...
    <div className="bulk-dms-page">
      <div className="page-header page-header--row">
        <div>
          ...
          <p className="page-subtitle">Compose and send a message to a filtered set of members.</p>
        </div>
        ...
        <div className="bulk-results-head">
          ...
          <div className="bulk-results-tools">
            ...
            <button
              ...
              onClick={() => onNotify?.("Member list refreshed")}
              title="Refresh"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="table-wrapper table-wrapper--scroll">
          <table className="bulk-results-table">
            ...
            <tbody>
              {matched.length === 0 ? (
                <tr>
                  <td colSpan={5} className="table-empty">No members match the current filters.</td>
                </tr>
              ) : (
                matched.slice(0, 50).map(member => (
                  <tr key={member.id}>
                    ...
                    <td className="table-text bulk-member-communities">
                      {member.communities.map(communityLabel).join(", ")}
                    </td>
                  </tr>
                ))
              )}
